import React, { useRef, useState } from 'react'//useRef pegar referencia
...
// O objeto retornado presistira durante todo o circulo ce vida do componente.
...
const animation = (toValue) => Animated.timing(animatedValue, {
  ...
  const onPress = () => {
    setIndice(indice === 1 ? 0 : 1)// garantir a volta
...
circulo: {
  ...
  borderRadius: TAMANHO_CIRCULO/2,// passar metade o tamanho
